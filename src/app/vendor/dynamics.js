...
(function() {
  var Color, DecomposedMatrix, InterpolableColor, InterpolableConcatenatedArray, InterpolableWithUnit, Matrix, Set, Vector, animationTick, animations, applyDefaults, applyFrame, axisForTransformProperty, cacheFn, createInterpolable, degProperties, dynamics, evaluateProperty, getCurrentProperties, isCSSProperty, noUnitProperties, parseProperties, prefixFor, propertyWithPrefix, pxProperties, roundf, runLoopRunning, runLoopTick, startRunLoop, toDashed, transformProperties, transformValueForProperty, unitForProperty,
  ...
  noUnitProperties = new Set(['opacity', 'transform', 'background', 'backgroundColor']);

  isCSSProperty = function(property) {
    return noUnitProperties.contains(property) || pxProperties.contains(property) || transformProperties.contains(property);
  };
  ...
  getCurrentProperties = function(el, keys) {
    var attributeValue, key, properties, style, _i, _j, _len, _len1;
    properties = {};
    if (el.style != null) {
      ...
      for (_i = 0, _len = keys.length; _i < _len; _i++) {
        ...
        if (transformProperties.contains(key)) {
          ...
          if (attributeValue != null) {
            ...
            properties[key] = createInterpolable(0);
          }
        }
      }
    } else {
  ...
  InterpolableConcatenatedArray = (function() {
    function InterpolableConcatenatedArray(values, sep) {
      this.values = values;
      this.sep = sep;
      this.format = __bind(this.format, this);
      this.interpolate = __bind(this.interpolate, this);
    ...
    InterpolableConcatenatedArray.prototype.interpolate = function(endInterpolable, t) {
      ...
      return new InterpolableConcatenatedArray(newValues, this.sep);
    };

    InterpolableConcatenatedArray.prototype.format = function() {
      var values;
    ...
    InterpolableConcatenatedArray.createFromArray = function(arr, sep) {
      var values;
    ...
    InterpolableConcatenatedArray.create = function(value) {
      var arr, sep, seps, _i, _len;
      if (value instanceof Array) {
        return InterpolableConcatenatedArray.createFromArray(value, null);
      }
      if (typeof value !== "string") {
        return;
      }
      ...
      for (_i = 0, _len = seps.length; _i < _len; _i++) {
        ...
        arr = value.split(sep);
        if (arr.length > 1) {
          return InterpolableConcatenatedArray.createFromArray(arr, sep);
        }
      }
      return null;
    };

    return InterpolableConcatenatedArray;
  ...
  InterpolableColor = (function() {
    ...
    InterpolableColor.prototype.interpolate = function(endInterpolable, t) {
      ...
      return new InterpolableColor(new Color(rgb));
    };
  ...
  Matrix = (function() {
    ...
    Matrix.transformStringToMatrixString = cacheFn(function(transform) {
      ...
      result = style.transform || style[propertyWithPrefix("transform")];
  ...
  evaluateProperty = function(start, end, y) {
    ...
    if (start == null) {
      ...
      return _results;
    } else if (start.interpolate != null) {
    ...
    for (k in properties) {
      ...
      if (isCSSProperty(k)) {
        if (transformProperties.contains(k)) {
          ...
          } else if (v instanceof DecomposedMatrix) {
            el.style[propertyWithPrefix(k)] = v.toMatrix().toString();
          }
        } else {
          if (v.format != null) {
            v = v.format();
  ...
  dynamics.animate = function(el, properties, options) {
    ...
    if (transforms.length > 0) {
      endProperties['transform'] = Matrix.fromTransform(Matrix.transformStringToMatrixString(transforms.join(' '))).decompose();
    }
