...
module.exports = Fullscreen;}});this.require.define({ "timeline" : function(exports, require, module) {var Controller, PhotosGroupsView, Timeline, TimelineView, View, get, router, scroll,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Timeline = (function(_super) {
  ...
  Timeline.prototype.load = function() {
    return get('/data/info.json', this.onLoad);
  };
...
}.apply({});}});this.require.define({ "dynamics2.js" : function(exports, require, module) {// Generated by CoffeeScript 1.7.1
(function() {
  var applyDefaults, dynamics;
